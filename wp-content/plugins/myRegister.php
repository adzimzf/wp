...
<li class='login'><a href="https://www.strava.com/login" class="btn-transparent btn-login button">Log In</a></li>
</ul>
</div>
</header>
</div>
...
<form action='https://www.strava.com/join' autocomplete='off' class='order signup website' method='POST'>
